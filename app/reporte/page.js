  ...
  return (
    <div style={{ maxWidth: 1000, margin: '0 auto', paddingBottom: '3rem' }}>
      <div style={{ background: 'var(--imss-verde-oscuro)', padding: '1.25rem 1.5rem', display: 'flex', alignItems: 'center', gap: 14 }}>
        ...
        <span style={{ marginLeft: 16, fontSize: 11, background: 'rgba(255,255,255,0.15)', color: 'var(--imss-verde-claro)', padding: '3px 10px', borderRadius: 12 }}>
          Solo consulta
        </span>
          ...
          <tbody>
            {tablaResumen.map((fila) => (
              <tr key={fila.cuenta} style={{ borderBottom: '1px solid #f0f0ee' }}>
                ...
                <td style={{ padding: '8px 4px', color: comentarios[fila.cuenta] ? 'inherit' : 'var(--texto-secundario)', fontStyle: comentarios[fila.cuenta] ? 'normal' : 'italic' }}>
